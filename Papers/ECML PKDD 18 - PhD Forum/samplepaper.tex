...
%
\begin{abstract}
%TODO How does people read ML? As 'em' 'el'? Or as Machine Learning? For the first one, you should use 'an ML' as article. for the second one, it is 'a ML'.
...
%TODO Please use intuitive keys for your bibliography!
...
%TODO I buy most of these excuses and arguements however I think in order to make it more scientifically sellable and not subjective opinions, you will need references to support your claims, or good empiric results (not ad hoc ones done on friends ;) )
%TODO You may consider reformulating some of these to make a bridge tp your objectives. For example, saying that you want to also investigave to which degree these other tools are making ML easier for people (because you have a suspition about this etc)
...
%TODO the following is good, but I am missing the clear contribution. Is it in combining AutoML, XAI and HCI, all in one piece?
...
%TODO not only sensitivity since it does not truly apply for smart city, but also the "ignorance" of the experts wrt data science
